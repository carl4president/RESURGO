    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
				...
				<div class="form-group">
                    <label for="edit_availability" class="col-sm-3 control-label">Position Available</label>

                    <div class="col-sm-9">
                      <input type="number" class="form-control" id="edit_availability" min="1" name="availability">
                    </div>
                </div>
                <div class="form-group">
