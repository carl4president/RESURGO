                  ...
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                      echo "
                        ...
                        <td>" . $row['duration'] . "</td>
                        <td>" . $row['reason'] . "</td>
                        <td><span class='badge badge-success' style='color: #fff; background-color: #28a745;'>" . $row['status'] . "</span></td>
                        ...
                        <button class='btn btn-primary btn-sm accept btn-flat drpd-btn' data-id='".$row['id']."'><i class='fa fa-check'></i>  Accept</button>
                        <button class='btn btn-danger btn-sm reject btn-flat drpd-btn' data-id='".$row['id']."'><i class='fa fa-trash'></i> Reject</button>
                        </div>
                        </div>
                      </td>
                        </tr>
